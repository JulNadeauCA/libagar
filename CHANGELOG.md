...
- Back [AG\_{Push,Pop}BlendingMode()](https://libagar.org/man3/AG_PushBlendingMode) with a proper stack of blending states. Also support alternate blending modes `MODULATE`, `DECAL`, `BLEND` and `REPLACE`.
