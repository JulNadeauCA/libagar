...
struct {
  ...
  { "AG_ObjectClassSpec *", sizeof (AG_ObjectClassSpec *) },
  { "struct ag_object_class_spec *", sizeof (struct ag_object_class_spec *) },
  { "AG_ObjectClassSpec", sizeof (AG_ObjectClassSpec) },
  { "struct ag_object_class_spec", sizeof (struct ag_object_class_spec) },
  ...
  { "struct ag_namespace *", sizeof (struct ag_namespace *) },
  { "AG_Namespace", sizeof (AG_Namespace) },
  { "struct ag_namespace", sizeof (struct ag_namespace) },
