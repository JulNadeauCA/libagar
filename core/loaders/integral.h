/*	$Csoft: integral.h,v 1.2 2005/09/27 00:25:18 vedge Exp $	*/
/*	Public domain	*/
...
__inline__ Uint64 AG_ReadUint64(AG_Netbuf *);
__inline__ void	  AG_WriteUint64(AG_Netbuf *, Uint64);
__inline__ void	  AG_PwriteUint64(AG_Netbuf *, Uint64, off_t);
