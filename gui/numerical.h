...
#define AG_NUMERICAL_NO_POS_INF 0x40   /* Disallow "inf" or infinity */
#define AG_NUMERICAL_NO_NEG_INF 0x80   /* Disallow "-inf" or negative infinity */
...
#define  AG_NUMERICAL_ISA(o)    (((AGOBJECT(o)->cid & 0xff000000) >> 24) == 0x1B)
...
#define AG_cNUMERICAL_SELF()   AGcNUMERICAL( AG_cOBJECT(0,         "AG_Widget:AG_Numerical:*") )
#define AG_cNUMERICAL_PTR(n)   AGcNUMERICAL( AG_cOBJECT((n),       "AG_Widget:AG_Numerical:*") )
#define AG_cNUMERICAL_NAMED(n) AGcNUMERICAL( AG_cOBJECT_NAMED((n), "AG_Widget:AG_Numerical:*") )

__BEGIN_DECLS
extern AG_WidgetClass agNumericalClass;

AG_Numerical *_Nonnull AG_NumericalNew(void *_Nullable, Uint, const char *_Nullable,
...
AG_Numerical *_Nonnull AG_NumericalNewInt(void *_Nullable, Uint,
                                          const char *_Nullable, const char *_Nullable,
					  int *_Nonnull);
AG_Numerical *_Nonnull AG_NumericalNewIntR(void *_Nullable, Uint, const char *_Nullable,
