...
const char *agStyleDefault_Data = 
	...
	" * -------------                --------\n"
	" * Widgets of class (exact)     AG_Box\n"
	" * Widgets of class (pattern)   AG_Widget:AG_Box:*\n"
	" * Child widgets of class       AG_FontSelector > AG_Tlist\n"
	" * The child widget named       AG_Combo > \"trigger\"\n"
	" *\n"
	" * Widgets inherit colors and fonts from their parents by default.\n"
	" * Margins, paddings and spacings are not inherited. Style attributes\n"
	" * can be overridden with per-widget instance variables.\n"
	" *\n"
