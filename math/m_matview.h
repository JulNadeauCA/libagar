...
#define   MMATVIEW(o)        ((M_Matview *)(o))
#define  McMATVIEW(o)        ((const M_Matview *)(o))
...
#define M_cMATVIEW_SELF()   McMATVIEW( AG_cOBJECT(0,         "AG_Widget:M_Matview:*") )
#define M_cMATVIEW_PTR(n)   McMATVIEW( AG_cOBJECT((n),       "AG_Widget:M_Matview:*") )
#define M_cMATVIEW_NAMED(n) McMATVIEW( AG_cOBJECT_NAMED((n), "AG_Widget:M_Matview:*") )
