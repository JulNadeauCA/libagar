...
typedef struct sg_vertex {
	...
	Uint flags;
#define SG_VERTEX_SELECTED    0x01          /* Vertex is selected */
#define SG_VERTEX_HIGHLIGHTED 0x02          /* Vertex is highlighted */
...
typedef struct sg_edge {
	Uint flags;
#define SG_EDGE_SAVED       0x01            /* For the save operation */
#define SG_EDGE_SELECTED    0x02            /* Edge is selected */
#define SG_EDGE_HIGHLIGHTED 0x04            /* Edge is highlighted */
...
typedef struct sg_facet {
	...
	Uint n;                             /* No. of Edges (3 or 4) */
	Uint flags;
#define SG_FACET_SELECTED    0x01           /* Facet is selected */
#define SG_FACET_HIGHLIGHTED 0x02           /* Facet is highlighted */
...
#define SG_OBJECT_NODUPVERTEX 0x02          /* Check for duplicate vertices */
	Uint               nVtx;
...
#define   SGOBJECT(o)        ((SG_Object *)(o))
#define  SGcOBJECT(o)        ((const SG_Object *)(o))
#define  SG_OBJECT_ISA(o)    (((AGOBJECT(o)->cid & 0xffff0000) >> 16) == 0x7A05)
...
#define SG_cOBJECT_SELF()   SGcOBJECT( AG_cOBJECT(0,         "SG_Node:SG_Object:*") )
#define SG_cOBJECT_PTR(n)   SGcOBJECT( AG_cOBJECT((n),       "SG_Node:SG_Object:*") )
#define SG_cOBJECT_NAMED(n) SGcOBJECT( AG_cOBJECT_NAMED((n), "SG_Node:SG_Object:*") )

/* Internal shorthands */
#ifdef _AGAR_SG_INTERNAL
# define OBJ_V(o,idx)        (SGOBJECT(o)->vtx[idx].v)
# define OBJ_N(o,idx)        (SGOBJECT(o)->vtx[idx].n)
# define OBJ_ST(o,idx)       (SGOBJECT(o)->vtx[idx].st)
# define FACET_V(o,fct,edge) (SGOBJECT(o)->vtx[(fct)->e[edge]->v].v)
# define FACET_N(o,fct,edge) (SGOBJECT(o)->vtx[(fct)->e[edge]->v].n)
# define FACET_S(o,fct,edge) (SGOBJECT(o)->vtx[(fct)->e[edge]->v].s)
# define FACET_T(o,fct,edge) (SGOBJECT(o)->vtx[(fct)->e[edge]->v].t)
# define EDGE_V(o,edge)      (SGOBJECT(o)->vtx[(edge)->v].v)
# define EDGE_N(o,edge)      (SGOBJECT(o)->vtx[(edge)->v].n)
# define EDGE_S(o,edge)      (SGOBJECT(o)->vtx[(edge)->v].s)
# define EDGE_T(o,edge)      (SGOBJECT(o)->vtx[(edge)->v].t)
# define LFACE(e) ((e)->f)      /* Halfedge traversal to left face */
# define RFACE(e) ((e)->oe->f)  /* Halfedge traversal to right face */
