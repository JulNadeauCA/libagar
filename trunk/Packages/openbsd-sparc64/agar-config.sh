#!/bin/sh
#
# Static agar-config for OpenBSD/sparc64 binary packages.
# Public domain
#
...
if [ "$1" = "--libs" ]; then
	echo "-L${PREFIX}/lib -L/usr/local/lib -L/usr/X11R6/lib -lag_gui -lag_core -lSDL -pthread -lm -lX11 -lXext -lusbhid -lfreetype -lz -lGL -lm -ljpeg -lpthread"
fi
