...
Extends Agar::Widget and Agar::Object. Please see AG_Scrollbar(3) for a
...
=item B<$widget = Agar::Scrollbar-E<gt>newHoriz($parent,{flags})>

=item B<$widget = Agar::Scrollbar-E<gt>newVert($parent,{flags})>
...
L<Agar>, L<Agar::Widget>, L<Agar::Object>, L<AG_Scrollbar(3)>
