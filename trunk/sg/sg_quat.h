...
SG_Quat SG_QuatConj(SG_Quat);
SG_Quat SG_QuatConjp(const SG_Quat *);
void	SG_QuatConjv(SG_Quat *);

SG_Quat SG_QuatScale(SG_Quat, SG_Real);
SG_Quat SG_QuatScalep(const SG_Quat *, SG_Real);
void	SG_QuatScalev(SG_Quat *, SG_Real);

SG_Quat	SG_QuatConcat(const SG_Quat *, const SG_Quat *);
SG_Quat	SG_QuatMult(SG_Quat, SG_Quat);
...
SG_Quat SG_QuatNorm(SG_Quat);
SG_Quat SG_QuatNormp(const SG_Quat *);
void	SG_QuatNormv(SG_Quat *);

SG_Quat SG_QuatInverse(SG_Quat);
SG_Quat SG_QuatInversep(const SG_Quat *);
void	SG_QuatInversev(SG_Quat *);
